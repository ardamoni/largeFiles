...
CREATE TABLE IF NOT EXISTS `property` (
  ...
  `structure_code` int DEFAULT NULL,
  `ownerid` int DEFAULT NULL,
  `prop_code` int NOT NULL,								-- all properties must have a code if not assigned then default is 0   
  `prop_descriptor` varchar(50) DEFAULT NULL,
  `rate_code` int NOT NULL,								-- all properties must have a rate code, if not assigned then default is 0 - exempt from rate
  `rate_impost_code` int DEFAULT NULL,					-- if not assigned then default is 0 - exempt from rate
  ...
  `material_type_title` varchar(50) DEFAULT NULL,
  `roofing_type` int DEFAULT NULL,
  `roofing_type_title` varchar(50) DEFAULT NULL,
  `storeys` int DEFAULT NULL,
  `persons` int DEFAULT NULL,  
  `prop_value` float DEFAULT NULL,
  `planningpermit` varchar(30) DEFAULT NULL,
  `planningpermit_no` varchar(30) DEFAULT NULL,
  `buildingpermit` varchar(30) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `business` (
  ...
  `date_end` int(11) DEFAULT NULL, 
  `activestatus` boolean DEFAULT NULL,			-- default NULL is active
  `category_code` int NOT NULL,					-- all businesses must have a busines category code e.g. Restaurant is 6403
  ...
  `business_code_name` varchar(100) DEFAULT NULL,   
  `assessed` int(11) DEFAULT NULL,
  `comments` varchar(50) DEFAULT NULL,
  `utm_x` int(11) DEFAULT NULL,
  `utm_y` int(11) DEFAULT NULL,  
